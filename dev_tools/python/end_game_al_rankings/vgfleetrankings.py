...
OUTPUT_PATHS = ["../../src/db/rankings/vgFleetRankings.json"]
...
def process_sheet(sheet_name):
    ...
    for row in values:
        ...
        ranking = {
            ...
            "aoedmg": int(row_data["AoE Dmg"]) if row_data.get("AoE Dmg") else None,
            "offensivebuff": (
            ...
            "asw": int(row_data["ASW"]) if row_data.get("ASW") else None,
            "defensivebuff": (
                int(row_data["Defense Buff"]) if row_data.get("Defense Buff") else None
            ),
        }
